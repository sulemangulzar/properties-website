    ...
    <>
      <div className="bg-primary font-custom py-6">
        <div className="flex flex-col items-center justify-center mx-2 gap-12">
          ...
          {/* divs  */}
          <div className="relative grid grid-cols-2 grid-row-2 items-center justify-center my-4">
            {/* <div className="absolute left-[48%] w-4 h-4 rounded-full bg-white"></div> */}
            {/* 1 */}
            <div className="w-44 h-44 md:w-64 md:h-64 xl:w-72 xl:h-72 border-b border-r rounded border-white/40">
            ...
            {/* 2 */}
            <div className="w-44 h-44 md:w-64 md:h-64 xl:w-72  xl:h-72  border-white/40">
              <div className="flex items-start mx-2 my-1 ">
                <span>
                  <h1 className="text-white text-sm tracking-tighter">
                    Awards
            ...
            {/* 4 */}
            <div className="w-44 h-44 md:w-64 md:h-64 xl:w-72  xl:h-72 border-l border-t rounded border-white/40">
              <div className="flex items-start mx-2 my-1 ">
                <span>
